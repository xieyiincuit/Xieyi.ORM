...
public class CacheOptionsConst
{
    ...
    internal static string GetQueryCacheKeysCacheKey(string dataBaseName)
    {
        return $"{CacheKey_QueryCacheKeys}{dataBaseName}";
    }

    internal static string GetTableCacheKeysCacheKey(string dataBaseName)
    {
        return $"{CacheKey_TableCacheKeys}{dataBaseName}";
    }
}